...
With p5 (and I believe html canvas as well) an rectangle is easily created. The colors are chosen from the _gruvbox_ theme with a dark grey background color `#1D2021` and a bluish foreground color `#83A598`. The gruvbox color theme originated from the Vim editor.
```js
