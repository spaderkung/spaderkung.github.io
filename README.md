...
With p5 (and I believe html canvas as well) an rectangle is easily created. The colors are chosen from the gruvbox theme with background color `#1D2021` and foreground color a bluish `#83A598`.
```js
